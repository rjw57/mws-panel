...
urlpatterns = [
    ...
    url(r'^vhost/(?P<vhost_id>[0-9]+)/apache_owned$', sitesmanagement.views.vhost_onwership,
        name='vhostapache'),

    # Domains management
    url(r'^add_domain/(?P<vhost_id>[0-9]+)/$', sitesmanagement.views.add_domain,
        name='sitesmanagement.views.add_domain'),
    url(r'^set_dn_as_main/(?P<domain_id>[0-9]+)/$', sitesmanagement.views.set_dn_as_main,
        name='sitesmanagement.views.set_dn_as_main'),
    ...
    url(r'^unix_groups/(?P<service_id>[0-9]+)/$', UnixGroupListView.as_view(),
        name='listunixgroups'),
    url(r'^unix_groups/(?P<service_id>[0-9]+)/add/$', UnixGroupCreate.as_view(),
        name='createunixgroup'),
    url(r'^unix_groups/edit/(?P<ug_id>[0-9]+)/$', UnixGroupUpdate.as_view(),
        name='updateunixgroup'),
    url(r'^unix_groups/delete/(?P<ug_id>[0-9]+)/$', UnixGroupDelete.as_view(),
        name='deleteunixgroup'),

    # Snapshot management
    url(r'^create_snapshot/(?P<service_id>[0-9]+)/$', SnapshotCreate.as_view(),
        name='createsnapshot'),
    url(r'^delete_snapshot/(?P<snapshot_id>[0-9]+)/$', SnapshotDelete.as_view(),
        name='deletesnapshot'),
    ...
    url(r'^media/billing/(?P<filename>[^/]+)$', sitesmanagement.views.po_file_serve,
        name='sitesmanagement.views.po_file_serve'),
    ...
    url(r'^termsandconditions/$', sitesmanagement.views.termsconds,
        name='sitesmanagement.views.termsconds'),
    ...
    url(r'^stats/datarequests$', apimws.views.statsdatarequests,
        name='apimws.views.statsdatarequests'),
